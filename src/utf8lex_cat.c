...
const utf8lex_cat_t UTF8LEX_CATEGORIES[UTF8LEX_NUM_CATEGORIES] =
  {
    // Cats:
    UTF8LEX_CAT_OTHER_NA,
    UTF8LEX_CAT_LETTER_UPPER,
    ...
    // Groups:
    UTF8LEX_GROUP_OTHER,
    UTF8LEX_GROUP_NOT_OTHER,
    UTF8LEX_GROUP_LETTER,
    UTF8LEX_GROUP_NOT_LETTER,
    UTF8LEX_GROUP_MARK,
    UTF8LEX_GROUP_NOT_MARK,
    UTF8LEX_GROUP_NUM,
    UTF8LEX_GROUP_NOT_NUM,
    UTF8LEX_GROUP_PUNCT,
    UTF8LEX_GROUP_NOT_PUNCT,
    UTF8LEX_GROUP_SYM,
    UTF8LEX_GROUP_NOT_SYM,
    UTF8LEX_GROUP_WHITESPACE,
    UTF8LEX_GROUP_NOT_WHITESPACE,
    UTF8LEX_GROUP_HSPACE,
    UTF8LEX_GROUP_NOT_HSPACE,
    UTF8LEX_GROUP_VSPACE,
    UTF8LEX_GROUP_NOT_VSPACE,
    // All:
    UTF8LEX_GROUP_ALL
  };
